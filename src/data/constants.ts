...
export const SKILLS: Record<SkillNames, Skill> = {
  [SkillNames.JS]: {
    ...
    name: "js",
    label: "JavaScript",
    shortDescription: "yeeting code into the DOM since '05, no cap! 💯🚀",
    color: "#f0db4f",
...
using use = useUsing("use")`,
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "Data & scripting powerhouse 🐍",
    color: "#3776AB",
  ...
  [SkillNames.SCIKITLEARN]: {
    ...
    name: "scikitlearn",
    label: "Scikit-learn",
    shortDescription: "ML algorithms library 🤖",
    color: "#F7931E",
  ...
  [SkillNames.MATPLOTLIB]: {
    ...
    name: "matplotlib",
    label: "Matplotlib",
    shortDescription: "Plotting & visualization 📊",
    color: "#11557C",
  ...
  [SkillNames.PANDAS]: {
    ...
    name: "pandas",
    label: "Pandas",
    shortDescription: "DataFrames that hit different 🐼📊",
    color: "#150458",
  ...
  [SkillNames.NUMPY]: {
    ...
    name: "numpy",
    label: "NumPy",
    shortDescription: "Array math on steroids, no cap! 🔢⚡",
    color: "#013243",
  ...
  [SkillNames.SEABORN]: {
    ...
    name: "seaborn",
    label: "Seaborn",
    shortDescription: "Making your plots aesthetic af 📈✨",
    color: "#4C72B0",
  ...
  [SkillNames.FASTAPI]: {
    ...
    name: "fastapi",
    label: "FastAPI",
    shortDescription: "APIs going brrrr at lightning speed ⚡🚀",
    color: "#009688",
